...
public enum AlipayField {
    ...
    /**
     * <pre>
     * 设置请求出错时的通知页面路径(该功能需要联系支付宝开通) 当商户通过该接口发起请求时，如果出现提示报错， 
    ...
    PAY_USER_ID("pay_user_id", "付款账号ID"),
    PAY_USER_NAME("pay_user_name", "付款账号姓名"),
    PAY_ACCOUNT_NO("pay_account_no", "付款账号"),
    SUCCESS_DETAILS("success_details", "转账成功的详细信息"),
    FAIL_DETAILS("fail_details", "转账失败的详细信息"),
     ...
     * </pre>
     */
    ACCOUNT_NAME("account_name", "付款账号名"),
    BATCH_FEE("batch_fee", "付款总金额"),
    EMAIL("Email", "付款账号"),
    PAY_DATE("pay_date", "支付日期"),
    BUYER_ACCOUNT_NAME("buyer_account_name", "付款账号别名"),
    EXTEND_PARAM("extend_param", "业务扩展参数"),
    DEFAULT_BANK("defaultbank", "默认银行")
    ;
